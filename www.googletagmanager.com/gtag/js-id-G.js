    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_ruleResult": ["macro", 4],
                "vtp_enableIpRegex": true,
                "tag_id": 17
            }, {
                ...
                "priority": 13,
                "vtp_instanceDestinationId": "G-EB72761B8J",
                "tag_id": 32
            }, {
...
*/
    ...
    li.je = Number("0") || 0;
    li.Za = "dataLayer";
    li.kn = "ChEI8OufswYQ0J/xnvL8gY3QARIlACtLRnZS+3MjA/IpzyAZiD4IRotXK8tED2VcZ1SOr71YNk11PBoC2SI\x3d";
    var ni = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;var Dj = {}
      ...
      , Mf = {
        ctid: "G-EB72761B8J",
        canonicalContainerId: "185255441",
        Sj: "G-EB72761B8J|GT-NFBKCQKQ",
        Tj: "G-EB72761B8J"
    };
    Dj.fe = zb("");
    function Fj() {
    ...
    ;function $z() {
        var a = [["cv", T(83) ? Zz() : "4"], ["rv", li.Og], ["tc", hf.filter(function(b) {
            return b
        }).length]];
    ...
    function fF() {
        ...
        T(36) && eF ? a = eF : (a.set("containerId", 'G-EB72761B8J'),
        a.set("version", '4'),
    ...
    iI.U = "sha256";
    function jI(a, b, c) {
        K(this.getName(), ["targetId:!string", "name:!string", "options:!PixieMap"], arguments);
        for (var d = b.split("."), e = kn(a), f = 0; f < d.length - 1; f++) {
            if (e[d[f]] === void 0)
                throw Error("sortRemoteConfigParameters failed, path points to an undefined object: " + d[f]);
            if (!Ya(e[d[f]]))
                throw Error("sortRemoteConfigParameters failed, path contains a non-object type: " + d[f]);
            e = e[d[f]]
        }
        if (e[d[f]] === void 0)
            throw Error("sortRemoteConfigParameters failed, destination is undefined " + d[f]);
        if (!Array.isArray(e[d[f]]))
            throw Error("sortRemoteConfigParameters failed, destination is not an array: " + d[f]);
        var g = J(c) || {}
          , h = g.sortKey;
        if (!h)
            throw Error("sortRemoteConfigParameters failed, option.sortKey is required");
        var m = g.ascending !== !1;
        e[d[f]].sort(function(n, p) {
            if (n[h] === void 0 || p[h] === void 0)
                throw Error("sortRemoteConfigParameters failed, object does not have required property: " + h);
            return m ? n[h] - p[h] : p[h] - n[h]
        });
    }
